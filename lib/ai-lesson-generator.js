...
function warmUpMessages(topic) {
  return [{
    ...
    content: [
      ...
      'Write teacherNotes as exactly four Markdown bullet points in this order:',
      ...
      '4. Give the teacher a ready-to-say opening phrase in natural A2 English, introduced with **Say:**.',
