...
function lessonMetadataMessages(topic) {
  return [{
    ...
    content: [
      ...
      'Use a polished child-friendly educational illustration style, one clear focal scene, and a composition that works as a finished cover without an overlaid title.',
