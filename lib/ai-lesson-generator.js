...
function lessonMetadataMessages(topic) {
  return [{
    role: 'system',
    content: [
      'You create visual metadata for one-to-one English lessons for A2 learners.',
...
function guidedSpeakingMessages(topic, vocabularyItems) {
  const { terms } = readingVocabularyTerms(vocabularyItems);
  return [{
    role: 'system',
    content: [
      ...
      'All generated content must be natural A2 English. Do not use Russian or any other language.',
...
function wrapUpMessages(topic, grammarTopic, vocabularyItems) {
  const { terms } = readingVocabularyTerms(vocabularyItems);
  return [{
    role: 'system',
    content: [
      ...
      'All generated copy, including Teacher’s Notes, must be natural English suitable for A2 learners. Do not use Russian or any other language.',
...
async function generateLessonMetadata({
  ...
  return generateStructuredSection({
    ...
    onDelta,
    fetchImpl,
    messages: lessonMetadataMessages(topic),
...
async function generateGuidedSpeaking({
  ...
  return generateStructuredSection({
    ...
    onDelta,
    fetchImpl,
    messages: guidedSpeakingMessages(topic, vocabularyItems),
...
async function generateWrapUp({
  ...
  return generateStructuredSection({
    ...
    onDelta,
    fetchImpl,
    messages: wrapUpMessages(topic, grammarTopic, vocabularyItems),
