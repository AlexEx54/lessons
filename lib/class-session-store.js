...
const { studentComponent, teacherComponent, applyComponentAction } = require('./class-component-handlers.js');
const supportedStages = new Set(['warm-up', 'lead-in', 'target-vocabulary', 'reading', 'listening', 'grammar-presentation']);
