...
const STAGE_BLUEPRINTS = Object.freeze([
  ...
  Object.freeze({ id: 'reading-listening', title: 'Reading / Listening', subtitle: 'Read the text', durationMinutes: 8, icon: 'book' }),
      ...
      const content = stage.id === 'warm-up'
        ...
        : stage.id === 'lead-in'
          ...
          : stage.id === 'target-vocabulary'
            ...
            : stage.id === 'reading-listening'
              ? [{
                type: 'teacherNote',
                id: 'reading-listening-teacher-note',
                text: '- Перед чтением спросите, знаком ли ученик с форматом blog post.\n- Попросите сначала прочитать заголовок и посмотреть на картинку, затем предположить, о чём будет текст.\n- Прочитайте текст по очереди и попросите назвать его главную идею.\n- После чтения обсудите, какие трудности помогли герою стать увереннее.',
              }, {
                type: 'textReading',
                id: 'reading-text',
