...
function createLessonDraft({ ownerAdminId, topic, warmUpTopic = topic, template, content }, database) {
  ...
  database.prepare(`
    INSERT INTO lesson_drafts (
      id, owner_admin_id, topic, warm_up_topic, template_id, status,
      content_json, created_at, updated_at
    ) VALUES (?, ?, ?, ?, ?, 'generating', ?, ?, ?)
  `).run(
    id, ownerAdminId, topic, warmUpTopic, template,
