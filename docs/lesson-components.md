...
Не используйте HTML, заголовки Markdown, ссылки, изображения, таблицы или вложенные списки. Не передавайте подпись, цвет или начальное состояние сворачивания: интерфейс добавляет их самостоятельно, а заметка всегда открыта при первой отрисовке.
